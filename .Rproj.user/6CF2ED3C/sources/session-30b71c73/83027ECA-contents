...
library(RgoogleMaps)  
library(ggmap)
base = get_map(location=c(-79.9,49.95,-79.5,50.05),zoom=15, maptype="stamen_terrain") # Get base map
map1 = ggmap(base)
map1
?get_map()
...
citation("ggplot2")
# Make final map
map2<-map1 +  geom_jitter(data = x2, aes(y = Lat, x = Long, color = Sample), width = 0.003, height = 0.003) + 
